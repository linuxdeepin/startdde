...
(function() {
  var Background, ConfirmDialog, DEEPIN_ITEM_ID, DOWN_ARROW, ENTER_KEY, ESC_KEY, LEFT_ARROW, Module, RIGHT_ARROW, SPACE_KEY, UP_ARROW, Widget, ajax, apply_animation, apply_flash, apply_refuse_rotate, apply_rotate, array_sort_min2max, assert, background, bindtextdomain, build_menu, calc_text_size, clamp, confirm_ok, confirmdialog, create_element, create_img, dbus_power, destory_all, dnd_is_deepin_item, dnd_is_desktop, dnd_is_file, e, echo, find_drag_target, frame_click, get_function_name, get_page_xy, get_path_base, get_path_name, inject_css, inject_js, message_text, option, option_text, option_text_force, power, power_can, power_force, power_request, powerchoose, remove_element, run_post, sortNumber, swap_element, timeId, _, _events,
