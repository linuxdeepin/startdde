// Code generated by "dbusutil-gen -output display_dbusutil.go -import github.com/godbus/dbus/v5,github.com/linuxdeepin/go-x11-client -type Manager,Monitor manager.go monitor.go"; DO NOT EDIT.
