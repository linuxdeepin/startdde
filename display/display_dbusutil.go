// Code generated by "dbusutil-gen -output display_dbusutil.go -import github.com/godbus/dbus,github.com/linuxdeepin/go-x11-client,pkg.deepin.io/lib/strv -type Manager,Monitor manager.go monitor.go"; DO NOT EDIT.
